...
export PATH=/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin\:/Library/Apple/usr/bin\:/usr/local/go/bin\:/opt/homebrew/bin\:/Users/matheusmortatti/.cargo/bin\:/Applications/iTerm.app/Contents/Resources/utilities\:/Users/matheusmortatti/go/bin\:/Users/matheusmortatti/git/whisper.cpp/build/bin\:/Users/matheusmortatti/.lmstudio/bin\:/opt/homebrew/opt/fzf/bin
